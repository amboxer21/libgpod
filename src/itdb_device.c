...
static const Itdb_IpodInfo ipod_info_table [] = {
    ...
    /* iPod nano touch (Seventh Generation) */
    {"X685",  16, ITDB_IPOD_MODEL_NANO_RED,       ITDB_IPOD_GENERATION_NANO_7, 14},
    {"X686",  16, ITDB_IPOD_MODEL_NANO_BLACK,     ITDB_IPOD_GENERATION_NANO_7, 14},
